<!--
  Profile README for @genericagent-author (display name: GenericAgent).
  Avatar (set in Settings → Profile, NOT inlined here): GA_logo_1024.png —
  a minimal monogram, white "GA" on a dark rounded square.
  This file is the README.md of the special repo named "genericagent-author".
-->
